...
**После:** Антон Долин в рецензии для «Медузы» отметил, что финальная сцена снята одним дублем без монтажных склеек.
...
**После:** За последние пять лет доля удалённой работы в России выросла с 8 до 29 процентов. В работе разбирается, как это изменило структуру занятости в трёх крупных сервисных компаниях.
