---
name: syscohada
description: "Référentiel SYSCOHADA révisé — Système normal ET Système minimal de trésorerie (SMT). `comptes/` : plan de comptes intégral (1403 comptes) — quel numéro, quel intitulé. `ecritures/` : écritures-types et cas pratiques (App. 1-142). `etats-financiers/` : maquette bilan/compte de résultat, correspondance compte-rubrique. `liasse/` : moteurs qui transforment une balance générale en liasse OHADA complète — Système normal (bilan, compte de résultat, TFT, notes annexes 1 à 36) et SMT (bilan, compte de résultat, notes 1 à 4), un classeur Excel par système, montants en formules traçables vers la balance. Devant une balance : demander d'abord le référentiel (SYSCOHADA ou SYCEBNL), puis le système, avant de générer. À utiliser pour tout numéro de compte SYSCOHADA/OHADA, toute écriture, toute rubrique de bilan/CR, ou pour monter/contrôler une liasse. Renvoie à audcif-acte-uniforme pour les règles d'évaluation. Ne jamais citer un compte, une écriture ou une rubrique de mémoire."
---
